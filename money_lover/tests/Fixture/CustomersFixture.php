...
class CustomersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'curent_wallet_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'username' => ['type' => 'unique', 'columns' => ['username'], 'length' => []],
            'email' => ['type' => 'unique', 'columns' => ['email'], 'length' => []],
            'fk_customer_account_id' => ['type' => 'foreign', 'columns' => ['id'], 'references' => ['accounts', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
