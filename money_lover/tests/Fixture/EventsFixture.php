...
class EventsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_event_customer_id' => ['type' => 'foreign', 'columns' => ['account_id'], 'references' => ['customers', 'id'], 'update' => 'cascade', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public $records = [
        [
            ...
            'ending_date' => '2016-04-25 10:34:09',
            'created_at' => 1461580449
        ],
    ];
}
